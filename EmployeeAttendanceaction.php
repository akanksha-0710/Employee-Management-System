...
<h4 class="margin-bottom-15">Attendance On Date - <?PHP echo $_POST['DateSID']; ?></h4>
...
$DateSID="";
if(isset($_POST['DateSID']) and  $_POST['DateSID']!='')
{
$DateSID=" and attenddatetime like '%".$_POST['DateSID']."%'";
}

$select_table = "select * from employeetable,employeeattend where employeetable.Eid=employeeattend.EID and concat(Ename,' ',Emobno) like '%".$SID."%'".$DateSID;
